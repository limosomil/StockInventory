...
--
-- Table structure for table `dispatch_details2`
--

CREATE TABLE `dispatch_details2` (
  `id` int(255) NOT NULL,
  `date` date NOT NULL,
...
--
-- Indexes for table `dispatch_details2`
--
ALTER TABLE `dispatch_details2`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `dispatch_details2`
--
ALTER TABLE `dispatch_details2`
